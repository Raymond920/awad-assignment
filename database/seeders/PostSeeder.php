...
class PostSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $posts = [
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/a/ad/Inter-Knot_Post_Monica%27s_Single.png/revision/latest/scale-to-width-down/128?cb=20240729213344',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/d/d2/Inter-Knot_Post_Modern_Art.png/revision/latest/scale-to-width-down/128?cb=20240804001043',
                'title' => '(Post) Am I the only one who doesn\'t understand modern art?',
                'author' => 'Sorry to be Cheesy:p',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/7/7d/Inter-Knot_Post_Default.png/revision/latest/scale-to-width-down/128?cb=20240804001556',
                'title' => '(Intel) Change in Activity: Lemnian Hollow',
                'author' => 'Super Dumpling',
                'content' => 'I got some info today from a pro that the activity in the Lemnian Hollow has plummeted!Proxies, we\'re in business~'
            ],
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/4/4a/Inter-Knot_Post_Commemorative_Flavor.png/revision/latest/scale-to-width-down/128?cb=20240804002353',
                'title' => '(Post) What flavor is Scarlet Noble\'s Founding Day commemorative flavor?',
                'author' => 'StrawberryMilk',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/4/4c/Inter-Knot_Post_Fixing_The_Road.png/revision/latest/scale-to-width-down/128?cb=20240804002605',
                'title' => '(Post) When are they gonna finish fixing the road???',
                'author' => 'Waterfall Soup Instant Noodles',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/6/69/Inter-Knot_Post_Starting_Soon.png/revision/latest/scale-to-width-down/128?cb=20240804003220',
                'title' => '(Post) "Vision Demolition Case" Starting Soon',
                'author' => 'MetisIntelligence_bot1',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/9/9f/Inter-Knot_Post_Beginner%27s_Guide_Right_Workplace.png/revision/latest/scale-to-width-down/128?cb=20240804004427',
                'title' => '(Notice) Beginner\'s Guide to the Hollows: Selecting the right workplace',
                'author' => 'Inter-Knot Team',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/5/5d/Inter-Knot_Post_Trip_Adventure.png/revision/latest/scale-to-width-down/128?cb=20240804151040',
                'title' => '(Inquiry) What do people think of the Hollow Raiders\' Ballet Twins Day Trip Adventure?',
                'author' => 'Ghost Hunter Team',
        ...
        $posts = [
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/3/32/Inter-Knot_Post_On_The_Run.png/revision/latest/scale-to-width-down/128?cb=20240804150343',
                'title' => '(Post) BREAKING! PERLMAN ON THE RUN!',
                'author' => 'Mr. Macrobachium',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/a/a6/Inter-Knot_Post_Suspect_Escapes.png/revision/latest/scale-to-width-down/128?cb=20240804150242',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/2/26/Inter-Knot_Post_Cleaning_Lady.png/revision/latest/scale-to-width-down/128?cb=20240804152913',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/f/f0/Inter-Knot_Post_Carrots.png/revision/latest/scale-to-width-down/128?cb=20240804161603',
                'title' => '(Info) Proxy Must-Knows: Carrots',
                'author' => 'Friend2Proxies_Kakami',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/8/84/Inter-Knot_Post_Latest_Bangboo_Model.png/revision/latest/scale-to-width-down/128?cb=20240804170931',
                'title' => '(Post) Anyone got their hands on the latest Bangboo model yet?',
                'author' => 'Sleep early Up late',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/b/be/Inter-Knot_Post_Welcome.png/revision/latest/scale-to-width-down/128?cb=20240804174135',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/3/3c/Inter-Knot_Post_Belobog_Wins_Bid.png/revision/latest/scale-to-width-down/128?cb=20240805010307',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/d/d8/Inter-Knot_Post_Ether_Aptitude.png/revision/latest/scale-to-width-down/128?cb=20240805133615',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/d/d0/Inter-Knot_Post_Hollow_Investigative_Association_Work.png/revision/latest/scale-to-width-down/128?cb=20240805133722',
                'title' => '(Question) What\'s it like working at the Hollow Investigative Association?',
                'author' => 'Layabout Legend',
        ...
        $posts = [
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/2/22/Inter-Knot_Post_Rescue_From_Hell.png/revision/latest/scale-to-width-down/128?cb=20240805133320',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/7/7e/Inter-Knot_Post_Hollow_Food_Rations.png/revision/latest/scale-to-width-down/128?cb=20240805133507',
                'title' => '(Discussion) What food rations should I take into the Hollow?',
                'author' => 'Spiral Wind Chime',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/c/ca/Inter-Knot_Post_About_To_Explode.png/revision/latest/scale-to-width-down/128?cb=20240805132857',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/5/5a/Inter-Knot_Post_Demolition_Delay.png/revision/latest/scale-to-width-down/128?cb=20240805133053',
                'title' => '(Post) Demolition delayed? What gives?',
                'author' => 'ButterflyJack',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/e/ea/Inter-Knot_Post_Vision_Scandal_Exposed.png/revision/latest/scale-to-width-down/128?cb=20240805132820',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/2/25/Inter-Knot_Post_Bangboo_Merchant_Attack.png/revision/latest/scale-to-width-down/128?cb=20240805132938',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/9/9b/Inter-Knot_Post_Tin_Master_Championships.png/revision/latest/scale-to-width-down/128?cb=20240808174930',
                'title' => '(Notice) The results of the 3rd "Tin Master Championships" are in!',
                'author' => 'IChooseTinMasterForm',
            ...
            [
                'image_url' => 'https://static.wikia.nocookie.net/zenless-zone-zero/images/b/b7/Inter-Knot_Post_Corporate_Commission.png/revision/latest/scale-to-width-down/128?cb=20240808175627',
