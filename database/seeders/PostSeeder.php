...
class PostSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Base timestamp for creating posts (30 days ago)
        $baseTimestamp = Carbon::now()->subDays(30);

        $posts = [
            [
                'image_url' => 'images/posts_image/' . $postIdCounter++ . '.png',
                ...
                'created_at' => $this->getRandomTimestamp($baseTimestamp),
                'updated_at' => $this->getRandomTimestamp($baseTimestamp),
            ],
            [
                'image_url' => 'images/posts_image/' . $postIdCounter++ . '.png',
    ...
    /**
     * Generate a random timestamp between base date and now
     */
    private function getRandomTimestamp($baseTimestamp)
    {
        $now = Carbon::now();
        $randomTimestamp = Carbon::createFromTimestamp(
            rand($baseTimestamp->timestamp, $now->timestamp)
        );
